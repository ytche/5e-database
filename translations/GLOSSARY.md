...
5. [伤害类型 (Damage Types)](#5-伤害类型-damage-types)
6. [魔法学派 (Magic Schools)](#6-魔法学派-magic-schools)
7. [语言 (Languages)](#7-语言-languages)
8. [武器属性 (Weapon Properties)](#8-武器属性-weapon-properties)
9. [种族 (Races)](#9-种族-races)
...
## 1. 核心属性 (Ability Scores)

| 英文 | 中文 | 缩写 | 说明 |
|-----|------|-----|------|
| Strength | 力量 | STR | 衡量身体力量、运动训练和原始物理力量 |
| Dexterity | 敏捷 | DEX | 衡量敏捷性、反应速度和平衡能力 |
| Constitution | 体质 | CON | 衡量健康、耐力和生命力 |
| Intelligence | 智力 | INT | 衡量精神敏锐度、记忆准确性和推理能力 |
| Wisdom | 感知 | WIS | 反映对周围世界的敏锐程度，代表洞察力和直觉 |
| Charisma | 魅力 | CHA | 衡量与他人有效互动的能力，包括自信和口才 |
...
| Primordial | 原初语 | 矮人文 |
| Sylvan | 木族语 | 精灵文 |
| Undercommon | 幽暗地域语 | 精灵文 |

---

## 8. 武器属性 (Weapon Properties)
...
| 英文 | 中文 | 生命骰 | 主要属性 |
|-----|------|-------|---------|
| Barbarian | 野蛮人 | d12 | 力量 |
| Bard | 吟游诗人 | d8 | 魅力 |
| Cleric | 牧师 | d8 | 感知 |
| Druid | 德鲁伊 | d8 | 感知 |
| Fighter | 战士 | d10 | 力量/敏捷 |
| Monk | 武僧 | d8 | 敏捷/感知 |
| Paladin | 圣武士 | d10 | 力量/魅力 |
| Ranger | 游侠 | d10 | 敏捷/感知 |
| Rogue | 游荡者 | d8 | 敏捷 |
| Sorcerer | 术士 | d6 | 魅力 |
| Warlock | 邪术师 | d8 | 魅力 |
...
| 英文 | 中文 | 完整名称 | 所属职业 | 类型 |
|-----|------|---------|---------|------|
| Berserker | 狂战士 | - | 野蛮人 | 原始道途 |
| Lore | 逸闻 | 逸闻学院 | 吟游诗人 | 吟游诗人学院 |
| Life | 生命 | 生命领域 | 牧师 | 神圣领域 |
| Land | 大地 | 大地结社 | 德鲁伊 | 德鲁伊结社 |
| Champion | 勇士 | - | 战士 | 武术范型 |
| Open Hand | 散打 | 散打宗 | 武僧 | 修道传统 |
| Devotion | 奉献 | 奉献之誓 | 圣武士 | 神圣誓约 |
| Hunter | 猎手 | - | 游侠 | 游侠范型 |
| Thief | 盗贼 | - | 游荡者 | 游荡者范型 |
| Draconic | 龙族 | 龙族血脉 | 术士 | 术士起源 |
| Fiend | 邪魔 | - | 邪术师 | 异界宗主 |
| Evocation | 塑能 | 塑能学派 | 法师 | 奥术传承 |
...
| Saving Throw: DEX | 敏捷豁免 |
| Saving Throw: CON | 体质豁免 |
| Saving Throw: INT | 智力豁免 |
| Saving Throw: WIS | 感知豁免 |
| Saving Throw: CHA | 魅力豁免 |
...
### 格式标准
1. **name 字段**: 中文翻译 + `name_en` 保留英文
2. **index/url 字段**: 永不翻译，保持原样
3. **desc 字段**: 中文翻译 + `desc_en` 保留英文

### 翻译优先级
1. 优先使用 D&D 5e 社区通用译名
2. 参考 5E 不全书 (https://5echm.kagangtuya.top/)
3. 保持术语一致性（同一术语全文统一）
